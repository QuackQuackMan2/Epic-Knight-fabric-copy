...
public class ItemRegistryHelper
{
	...
	public static void setId(Item.Properties p, String id) {
		try {
			...
			field.set(p, java.util.Optional.of(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.ITEM, net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("magistuarmory", id))));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
